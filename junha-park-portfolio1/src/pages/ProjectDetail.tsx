    ...
    <div className="pb-32">
      ...
      <section className="max-w-7xl mx-auto px-8 py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-32 items-center">
          ...
          <div className="bg-surface-container p-1 border border-outline-variant/30 overflow-hidden rounded-lg">
            <img alt="Technical sketch" className="w-full grayscale brightness-75 hover:grayscale-0 hover:brightness-100 transition-all duration-700 aspect-square object-cover" src={project.phase1.image} />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-8 py-32">
        <div className="flex flex-col md:flex-row gap-20">
          <div className="md:w-3/5 space-y-12">
            <div className="relative overflow-hidden group border border-outline-variant/30 rounded-xl">
              <img alt="Final Prototype" className="w-full object-cover aspect-video brightness-90 group-hover:brightness-100 transition-all duration-700" src={project.mainImage} />
              <div className="absolute bottom-6 left-6 bg-background/90 backdrop-blur-md px-6 py-4 border border-outline-variant/30 rounded-lg">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em]">Final Prototype — V.2.4</p>
              </div>
            </div>
            {project.gallery && project.gallery.length > 0 && (
              <div className="grid grid-cols-2 gap-8">
                {project.gallery.map((img: string, i: number) => (
                  <div key={i} className="group overflow-hidden border border-outline-variant/30 rounded-xl">
                    <img alt={`Detail ${i}`} className="aspect-square w-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src={img} />
                  </div>
                ))}
              </div>
            )}
              ...
              <div className="mt-16 p-10 bg-surface-container-low border border-primary/20 relative group overflow-hidden rounded-xl">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-outline uppercase tracking-widest font-bold">Chief Engineer</p>
                  </div>
                </div>
              </div>
            </div>
